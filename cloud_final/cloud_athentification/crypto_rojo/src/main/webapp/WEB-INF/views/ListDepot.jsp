 ...
 <!-- End Sidebar-->
  ...
  <form action="/ValiderDepot" method="post"> 
    <div class="container mt-5">
        <h2 class="text-center">Liste depot invalide</h2>
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <% 
                    ...
                    List<DepotRetraitTemporaire> depotRetraitTemporaires = (List<DepotRetraitTemporaire>) request.getAttribute("depots");
                %>
                <tr>
                ...
                <%
                    ...
                    if (depotRetraitTemporaires != null && !depotRetraitTemporaires.isEmpty()) { 
                        for (DepotRetraitTemporaire depotRetraitTemporaire : depotRetraitTemporaires) { %> 
                            ...
                            <td><%= depotRetraitTemporaire.getDepot() %></td>
                            ...
                            <input type="hidden" name="montant" value="<%= depotRetraitTemporaire.getDepot() %>" >
                        <% } } %>
                </tr>
            </tbody>
        </table> 
