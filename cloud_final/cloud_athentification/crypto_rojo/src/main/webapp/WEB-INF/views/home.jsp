...
<div class="bodyCrypto"> 
 <!-- End Sidebar-->
<main id="main" class="main">
    <section class="welcome-container">
        <h1>Bienvenue sur CRYTO</h1>
        <p>Investissez intelligemment dans l'avenir avec notre plateforme securisee et intuitive.</p>
        <a href="/ListCrypto" class="btn">Commencer</a>
    </section>
</main>
</div> 
  <!-- ======= Footer ======= -->
